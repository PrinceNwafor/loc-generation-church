/* ==========================================================================
   LOVE OF CHRIST GENERATION CHURCH — MAIN JAVASCRIPT
   ========================================================================== */
...
(function () {
  ...
  handleFormSubmit('newsletter-form', "You're subscribed! Welcome to the LOC family.");
  ...
  function showToast(message, type = 'success') {
    ...
    Object.assign(toast.style, {
      ...
      background: type === 'success' ? '#1A5C40' : '#C9A040',
  ...
  if (sermonSearch) {
    sermonSearch.addEventListener('input', () => {
      ...
      sermonCards.forEach(card => {
        ...
        card.style.display = (!query || title.includes(query) || speaker.includes(query) || series.includes(query)) ? '' : 'none';
      });
    });
  }
